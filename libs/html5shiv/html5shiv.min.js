...
/* скрипт, который генерирует область с описаним растения или района
метод createElement делает то....
используется технология работы с 
dom - что это*/